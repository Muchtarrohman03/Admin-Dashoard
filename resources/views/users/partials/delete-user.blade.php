<button onclick="delete_modal_{{ $loop->iteration }}.showModal()" class="btn btn-sm btn-error inline-flex items-center">
...
<dialog id="delete_modal_{{ $index }}" class="modal">
  <div class="modal-box">
    ...
    <div class="modal-action justify-end">
      ...
      <form enctype="multipart/form-data" method="POST" action="{{ route('admin.users.destroy', $user->id) }}" >
        @csrf
        @method('DELETE')
